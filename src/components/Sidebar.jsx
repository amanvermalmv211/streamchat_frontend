...
const Sidebar = () => {
  ...
  const { getUsers, users, selectedUser, setSelectedUser, isUsersLoading } = chatContextElements;
      ...
      <div className="overflow-y-auto w-full">
        {filteredUsers.map((user) => (
          <button
            ...
            className={`w-full p-3 flex items-center gap-3 hover:bg-base-300 transition-colors border-b ${selectedUser?._id === user._id ? "bg-slate-950 ring-1 ring-slate-950" : ""}`}>
